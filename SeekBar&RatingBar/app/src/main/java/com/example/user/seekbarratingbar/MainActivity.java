package com.example.user.seekbarratingbar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRatingBar.setOnRatingBarChangeListener(ratinBarOnChange);
    }
    ...
    private RatingBar.OnRatingBarChangeListener ratinBarOnChange = new RatingBar.OnRatingBarChangeListener() {
        @Override
